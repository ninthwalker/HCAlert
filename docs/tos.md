...
This Terms of Service Agreement (the "Agreement") is entered into between Echellon/Ninthwalker/Brentsflix ("Bot Owner") and the user ("User") of the HC Alert Discord bot (the "Bot").
